...
REGRESSION_PLANNER_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Design a high-precision PyCaret regression pipeline. **MANDATORY: Use `google_search_tool` to research ambiguous queries or domain-specific context.**\n\n"
    "RESOURCES:\n"
