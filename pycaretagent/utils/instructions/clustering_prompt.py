...
CLUSTERING_PLANNER_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Design a high-precision PyCaret clustering pipeline. **MANDATORY: Use `google_search_tool` ONLY to research PyCaret or Pandas documentation if needed.**\n\n"
    "RESOURCES:\n"
...
CLUSTERING_EXECUTOR_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Execute the ML plan using PyCaret's clustering module.\n\n"
    "RESOURCES:\n"
    f"PyCaret Functions: {CLUSTERING_SUPPORTED_FUNCTIONS}\n\n"
    "INPUT PLAN:\n"
    "{clustering_plan?}\n\n"
    "EXECUTION GUIDELINES:\n"
    "1. ENVIRONMENT: Use `UnsafeLocalCodeExecutor`. Import `pandas as pd`, `os`, and `pycaret.clustering`.\n"
