...
TS_PLANNER_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Design a high-precision PyCaret time series pipeline. **MANDATORY: Use `google_search_tool` ONLY to research PyCaret, MLflow, or Pandas documentation if needed.**\n\n"
    "RESOURCES:\n"
...
TS_EXECUTOR_INSTRUCTIONS = (
    ...
    "1. ENVIRONMENT: Use `UnsafeLocalCodeExecutor`. Import `mlflow`, `pandas as pd`, `os`, and `pycaret.time_series`.\n"
