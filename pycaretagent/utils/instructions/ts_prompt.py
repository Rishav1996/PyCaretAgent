...
TS_PLANNER_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Design a high-precision PyCaret time series pipeline. **MANDATORY: Use `google_search_tool` ONLY to research PyCaret or Pandas documentation if needed.**\n\n"
    "RESOURCES:\n"
...
TS_EXECUTOR_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Execute the ML plan using PyCaret's time_series module.\n\n"
    "RESOURCES:\n"
    f"PyCaret Functions: {TS_SUPPORTED_FUNCTIONS}\n\n"
    "INPUT PLAN:\n"
    "{ts_plan?}\n\n"
    "EXECUTION GUIDELINES:\n"
    "1. ENVIRONMENT: Use `UnsafeLocalCodeExecutor`. Import `pandas as pd`, `os`, and `pycaret.time_series`.\n"
