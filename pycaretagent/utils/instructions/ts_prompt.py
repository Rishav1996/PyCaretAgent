"""
Optimized instruction template for the Time Series Sub-Agent system.
"""
...
TS_EXECUTOR_INSTRUCTIONS = (
    ...
    "- Analyze: Use `csv_analytics_tool` to evaluate time index, frequency, and seasonality.\n"
    "- Visualize: Perform EDA. Save all figures (ACF/PACF, decomposition, trends) into `runs/{session_id?}/plots/` using `plt.savefig()`.\n\n"
    ...
    "SESSION_ID: <ID>\n"
    "PERFORMANCE SUMMARY: Table of top 3 models and their primary metrics (MASE, sMAPE, RMSE).\n"
