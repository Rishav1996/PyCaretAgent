...
CLASSIFICATION_PLANNER_INSTRUCTIONS = (
    ...
    "OBJECTIVE: Design a high-precision PyCaret classification pipeline. **MANDATORY: Use `google_search_tool` ONLY to research PyCaret, MLflow, or Pandas documentation if needed.**\n\n"
    "RESOURCES:\n"
...
CLASSIFICATION_EXECUTOR_INSTRUCTIONS = (
    ...
    "1. ENVIRONMENT: Use `UnsafeLocalCodeExecutor`. Import `mlflow`, `pandas as pd`, `os`, and `pycaret.classification`.\n"
