...
CLASSIFICATION_EXECUTOR_INSTRUCTIONS = (
    ...
    "   - METRICS & PARAMS: MANDATORY - Log every evaluation metric (Accuracy, AUC, Recall, etc.) using `mlflow.log_metric()`. Log any custom parameters passed to PyCaret functions using `mlflow.log_param()`.\n"
    "6. PYCARET SETUP:\n"
