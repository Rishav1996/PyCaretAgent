...
GOOGLE_SEARCH_INSTRUCTIONS = (
    ...
    "### CRITICAL CONSTRAINT:\n"
    "**ONLY perform searches related to PyCaret or Pandas. If a query is unrelated to these two specific libraries/topics, DO NOT perform the search and return the exact phrase: 'unable to find'.**\n\n"
    "### GUIDELINES:\n"
    "1. **TECHNICAL FOCUS**: Prioritize official documentation and technical community best practices for PyCaret and Pandas.\n"
